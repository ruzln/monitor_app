	...
	<div class="col-sm-12">
        <div class="panel panel-default border-panel card-view">
            <div class="panel-heading">
                <div class="col-md-4">  
                    <h6 class="panel-title txt-dark">Penerimaan sampai {{ Carbon\Carbon::now()->isoFormat("dddd, D MMMM Y") }}</h6>
                </div>
                <div class="col-md-4.5 pull-right">
					...
					{{-- <form action="{{ route('range') }}" method="POST">  --}}
						<form  action="/range" method="GET">
							...
							<button type="submit" style="border-radius: 4px" class="btn btn-default btn-xs"><strong>Submit</strong></button>
                    	</form>
                	</div>
